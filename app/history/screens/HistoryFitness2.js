...
function HistoryFitness2({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View>
        <Text>
          View your fitness history and our analysis of positive health effects
          that may be attributed to your current workout routine.
        </Text>
        <Image
          source={require('../../shared/assets/icon.png')}
          style={styles.avatar}
      ...
      <View>
        <Text>ADD APPROPRIATE TEXT HERE</Text>
        {/*<ProperSleepAnalysis />*/}
      </View>
      <View>
        <Text>ADD APPROPRIATE TEXT HERE</Text>
