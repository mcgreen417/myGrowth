...
function HistoryMealTracking({ route, navigation }) {
  ...
  if(data !== null) {
    ...
    const [pressedNutrient, setPressedNutrient] = useState(false);
            ...
            <View style={{ marginHorizontal: '5%', flexDirection: 'row', marginTop: 30, marginBottom: 20, }}>
              ...
              <View style={styles().textInputView}>
                <View style={styles().labelView}>
                  <Text
                    style={{
                      color: pressedNutrient ? '#4CB97A' : '#816868',
                      fontSize: 16,
                      fontWeight: 'bold',
                    }}>
                    Select Nutrient
                ...
                <View
                  style={{
                    flex: 1,
                    borderWidth: 1,
                    borderColor: pressedNutrient ? '#4CB97A' : '#816868',
                    justifyContent: 'flex-end',
                    borderRadius: 6,
                    paddingLeft: 12,
                  }}>
                  <Picker
                    ...
                    mode={'dropdown'}>
                    <Picker.Item label='Calories' value='calories' color='#816868' />
                    <Picker.Item label='Total fat' value='total_fat' color='#816868' />
                    <Picker.Item label='Total Protein' value='total_protein' color='#816868' />
                    <Picker.Item label='Total carbs' value='total_carbs' color='#816868' />
                  </Picker>
                </View>
              </View>
            </View>
