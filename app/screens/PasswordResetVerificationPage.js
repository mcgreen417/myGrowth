      ...
      <View style={{ justifyContent: 'center', alignItems: 'center', height: '100%' }}>
        ...
        <View>
          <View style={{ flexDirection: 'row' }}>
            <Text style={{ color: (global.colorblindMode ? global.cb_textColor : global.textColor) }}>Didn't receive a reset code? </Text>
            <TouchableOpacity>
              <Text style={{ color: (global.colorblindMode ? global.cb_hyperlinkedTextColor : global.hyperLinkedTextColor), textDecorationLine: 'underline' }}>Resend e-mail.</Text>
            </TouchableOpacity>
          </View>
        </View>
        {/* Login page redirect */}
