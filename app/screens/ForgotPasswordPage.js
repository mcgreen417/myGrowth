    ...
    <SafeAreaView style={styles().container}>
      ...
      <View style={{ justifyContent: 'center', alignItems: 'center', height: '100%' }}>
        ...
        <View style={styles().buttons}>
          ...
          <View style={{ marginVertical: 8 }} />
          <Button title='SUBMIT' color={(global.colorblindMode ? global.cb_optionButtonsColor : global.optionButtonsColor)} onPress={() => navigation.navigate('PasswordResetVerificationPage')} />
          <View style={{ marginVertical: 8 }} />
        </View>
        {/* Login page redirect */}
